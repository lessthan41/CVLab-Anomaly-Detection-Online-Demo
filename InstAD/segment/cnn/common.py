...
class NetworkFeatureAggregator(torch.nn.Module):
    ...
    def __init__(self, backbone, layers_to_extract_from, imagesize=256, device="cuda", train_backbone=False):
        ...
        self.preprocessing = Preprocessing(
            input_dims=self.feat_dims, output_dim=384
        )
    ...
    def feature_extraction(self, images, eval=True):
        self.outputs.clear()
    ...
    def forward(self, images, eval=True):
        ...
        features = self.feature_extraction(images, eval=eval)
    ...
    def feature_dimensions(self, input_shape):
        ...
        _output = self.feature_extraction(_input)
